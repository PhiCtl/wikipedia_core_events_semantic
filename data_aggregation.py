...
def match_over_months():
    ...
    dates = ['2015-07', '2015-08', '2015-09', '2015-10', '2015-11', '2015-12'] + \
            [f'{y}-{m}' for y in ['2016', '2017', '2018', '2019', '2020'] for m in
             [f'0{i}' if i < 10 else i for i in range(1, 13, 1)]] \
            + ['2021-01', '2021-02', '2021-03']
    dfs = dfs.where(dfs.date.isin(dates))\
    ...
    print(n)
    dfs_change.write.parquet("/scratch/descourt/processed_data/en/pageviews_en_articles_ev_march21.parquet")
